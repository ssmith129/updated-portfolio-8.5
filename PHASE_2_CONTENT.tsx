  ...
  <div className="bg-[#0F0F0F]/80 backdrop-blur-xl rounded-[25px] p-8 sm:p-10 lg:p-12 border border-[#1A1A1A] shadow-xl">
      ...
      <div className="space-y-3 mb-4">
        <div className="bg-red-50/10 rounded-lg p-4 border-l-4 border-red-500">
          ...
          <p className="text-sm text-[#D1D5DB] max-w-[75ch] leading-relaxed">
            "I can't defend tax positions I don't understand" — Transparency was
            non-negotiable for professional liability
          </p>
        </div>
    ...
    <div className="mt-8 bg-[#1A1A1A]/50 border-2 border-dashed border-[#6B7280] rounded-lg p-12 text-center">
      ...
      <p className="text-[#9CA3AF] text-xs max-w-[60ch] mx-auto">
        ...
        <br />
        Shows 4 themes from CPA research: Trust & Control (23 mentions),
        Autonomy & Speed (18 mentions), Compliance & Audit (15 mentions),
        Accuracy & Errors (12 mentions)
        <br />
        Includes verbatim quotes from interviews clustered by theme with
    ...
    <div className="mt-8">
      ...
      <div className="bg-[#1A1A1A]/50 border-2 border-dashed border-[#6B7280] rounded-lg p-12 text-center mb-6">
        ...
        <p className="text-[#9CA3AF] text-xs max-w-[60ch] mx-auto">
          ...
          <br />
          Compares Computis vs TaxBit, Cryptio, and CoinTracker across 9
          features
          <br />
          Highlights: Visual rule builder, AI confidence chips, and real-time
          anomaly detection as unique differentiators
        </p>
      </div>
        ...
        <div className="p-6 space-y-4 bg-[#0A0A0A]/50">
          ...
          <div className="bg-[#1A1A1A]/50 rounded-lg p-4">
            ...
            <p className="text-sm text-[#D1D5DB]">
              Took 3 extra weeks to build, but reduced support burden by 40% and
              unlocked $200K+ in enterprise sales
            </p>
          </div>
        </div>
