...
export const DesignEvolutionShowcase: React.FC<DesignEvolutionShowcaseProps> = ({
  stages,
}) => {
  const defaultStages: EvolutionStage[] = [
    {
      ...
      caption: "Quick sketches to explore interaction patterns for rule creation.",
      learnings: "Key question: How do we make AI suggestions transparent without overwhelming users?",
    },
    {
      number: 2,
      title: "Wireframe Testing",
      caption: "Wireframes tested with 3 CPAs to validate mental model.",
      learnings: "Learning: Users wanted to see ALL classification options upfront, not progressive disclosure.",
    },
    {
      number: 3,
      title: "High-Fidelity Prototype",
      caption: "High-fidelity prototype tested with 5 users for usability validation.",
      learnings: "Finding: Confidence percentages alone weren't enough -- added color-coded chips for at-a-glance scanning.",
    },
    {
      number: 4,
  ...
  return (
    <section className="py-16 px-6 my-16">
      ...
      <p className="text-base text-[#9CA3AF] mb-12 text-center max-w-3xl mx-auto leading-relaxed">
        Here's how the most critical feature -- automated classification rules -- evolved
        from initial sketches to the final shipped product.
      </p>
