  ...
  return (
    <>
      ...
      <header className="max-w-[1200px] mx-auto px-4 sm:px-8 lg:px-12 pt-16 pb-12 animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-500 relative z-10">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-[3.25rem] xl:text-[3.75rem] font-semibold text-[#0F172A] leading-tight lg:leading-[65px] tracking-[-0.03em] mb-[29px] max-w-[900px] h-auto grow-0">
