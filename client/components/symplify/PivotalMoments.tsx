  ...
  return (
    ...
    >
      <div ref={headingRef} className="reveal">
        <p className="text-xs font-semibold text-sym-amber uppercase tracking-widest mb-2">
          Turning Points
        </p>
        ...
        {moments.map((m) => (
          ...
          >
            <div className="px-6 pt-6 pb-4 flex items-start gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-sym-heading">{m.title}</h3>
                <p className="text-sm text-sym-muted italic">{m.subtitle}</p>
              </div>
            </div>

            <div className="px-6 pb-4">
              <p className="text-[15px] text-sym-body leading-relaxed whitespace-pre-line">
                {m.narrative.trim()}
              </p>
            </div>
