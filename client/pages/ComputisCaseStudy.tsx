  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <figure className="w-full max-w-6xl mx-auto mb-12 sm:mb-16 md:mb-20 lg:mb-24 animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-500">
        ...
        <figcaption className="text-center mt-4 sm:mt-6">
          <p className="text-sm sm:text-base text-gray-600 italic">
            Computis platform overview - transforming complex crypto tax
            workflows into intuitive user experiences
          </p>
        </figcaption>
      </figure>
            ...
            <div className="flex-1 space-y-6">
              <div className="flex flex-row flex-wrap gap-6">
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <p className="text-[18px] font-medium text-[#131417]">
                    Crypto Tax Automation – B2B Enterprise SaaS
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-[16px] text-[#131417]">
                      Figma, Miro, Jira, Notion, Webflow, GA
                    </p>
                  </div>
                  <div>
                    <p className="text-[16px] font-medium text-[#131417] mb-2">
                    ...
                    <p className="text-[16px] text-[#131417]">
                      CTO, PM, 2 Engineers, Selecto (Design/Dev Agency)
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-6 rounded-[25px] border border-green-200 hover:border-green-300 transition-all duration-300 hover:scale-[1.02]">
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <span className="text-[16px] text-[#131417]">
                    core modules launched with full audit trail UX
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-[200px]">
            ...
            <div className="flex-1 space-y-6">
              <p className="text-[20px] font-normal text-[#131417] leading-[150%] tracking-[-0.2px]">
                When I joined, Computis was a Python script tool that required
                devs to manually ingest crypto data and produce IRS forms.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-red-50 p-6 rounded-[25px] border border-red-200 transition-all duration-300 hover:border-red-300 hover:scale-[1.02]">
                  <p className="text-[18px] font-medium text-[#131417] mb-2">
                    📉 Before:
                  </p>
                  <p className="text-[16px] text-[#131417]">
                    No UI, no classification logic for CPAs, and no audit-ready
                    visibility.
                  </p>
                </div>
                <div className="bg-green-50 p-6 rounded-[25px] border border-green-200 transition-all duration-300 hover:border-green-300 hover:scale-[1.02]">
                  ...
                  <p className="text-[16px] text-[#131417]">
                    The IRS crackdown on crypto made demand for transparent tax
                    tooling skyrocket.
                  </p>
                </div>
              </div>
              <blockquote className="bg-[#131417] text-white p-8 rounded-[25px] italic text-[20px] leading-[150%] tracking-[-0.2px] transition-all duration-300 hover:scale-[1.02]">
                "We weren't just building a UI — we were replacing engineering
                dependence with user trust."
              </blockquote>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-[200px]">
            ...
            <div className="flex-1 space-y-6">
              <div className="bg-gray-50 p-6 rounded-[25px] transition-all duration-300 hover:bg-gray-100">
                ...
                <p className="text-[16px] font-medium text-[#131417] mb-3">
                  Scope:
                </p>
            ...
            <div className="flex-1 space-y-6">
                ...
                <table className="w-full min-w-[500px]">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      ...
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        Engineers had to triage all data
                      </td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
              ...
              <div className="bg-blue-50 p-6 rounded-[25px] border border-blue-200 transition-all duration-300 hover:border-blue-300 hover:scale-[1.02]">
                ...
                <p className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] mb-4">
                  This wasn't just a UI problem — it was a control handoff
                  problem.
                </p>
                <p className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px]">
                  We needed to shift trust from developers to CPAs by exposing
                  logic, version history, and override control.
                </p>
              </div>
              ...
              <blockquote className="bg-[#131417] text-white p-8 rounded-[25px] italic text-[20px] leading-[150%] tracking-[-0.2px] transition-all duration-300 hover:scale-[1.02]">
                ...
                "Enable any CPA to confidently explain their crypto tax report
                to a regulator — without needing a developer."
              </blockquote>
            </div>
          </div>
        </section>
              ...
              <div className="bg-white rounded-[25px] p-6 shadow-sm hover:shadow-md transition-all duration-300 overflow-x-auto">
                ...
                <table className="w-full min-w-[600px]">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        CPAs distrust automation
                      </td>
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        Add AI confidence badges + override tools
                      </td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        Analysts lack upload diagnostics
                      </td>
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        Build ingestion preview + error flagging
                      </td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                      ...
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        Enable audit logs and tagging workflows
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        FMV reconciliation is manual
                      </td>
                      <td className="py-4 px-4 text-[16px] text-[#131417]">
                        Create anomaly dashboards and severity indicators
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-[200px]">
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="bg-blue-50 p-6 rounded-[25px] border border-blue-200 transition-all duration-300 hover:border-blue-300 hover:scale-[1.02]">
                ...
                <p className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px]">
                  Computis was the only platform with a drag-and-drop rule
                  engine, AI transparency, audit logs, and FMV dashboards — all
                  built into a modular, white-labeled interface.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-[200px]">
            ...
            <div className="flex-1 space-y-6">
              <div className="space-y-16 lg:space-y-20">
                {/* Persona Cards */}
                <div>
                  <h3 className="text-xl sm:text-2xl font-medium text-[#131417] mb-8 lg:mb-12">
                    User Personas
                  </h3>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-8 lg:p-10 rounded-[25px] border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-500 hover:scale-[1.02] group">
                      <div className="flex items-center gap-6 mb-8">
                        ...
                        <div>
                          <h4 className="text-2xl font-semibold text-[#131417] mb-1">
                            David
                          </h4>
                          <p className="text-[#9FA0A3] text-lg font-medium">
                            Senior CPA
                          </p>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-blue-50 p-6 rounded-[20px] border border-blue-100">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h5 className="font-semibold text-[#131417]">
                              Primary Goals
                            </h5>
                          </div>
                          <ul className="text-sm text-[#555] space-y-2">
                            <li className="flex items-start gap-2">
                              ...
                              Efficient transaction processing for 50+ crypto
                              clients
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                              Ensure 100% compliance with evolving tax
                              regulations
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                        ...
                        <div className="bg-green-50 p-6 rounded-[20px] border border-green-100">
                          ...
                          <ul className="text-sm text-[#555] space-y-2">
                            <li className="flex items-start gap-2">
                              ...
                              <strong>Drag-and-drop rule builder</strong> for
                              custom categorization
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                              <strong>Bulk processing capabilities</strong> for
                              large datasets
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                              <strong>Real-time compliance validation</strong>{" "}
                              with tax rules
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="bg-teal-50 p-6 rounded-[20px] border border-teal-100">
                          ...
                          <ul className="text-sm text-[#555] space-y-2">
                            <li className="flex items-start gap-2">
                              ...
                              <strong>Advanced filtering options</strong> with
                              saved queries
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-teal-500 rounded-full mt-2 flex-shrink-0"></span>
                              <strong>Real-time collaboration tools</strong> for
                              team workflows
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-teal-500 rounded-full mt-2 flex-shrink-0"></span>
                              <strong>Automated report generation</strong> with
                              custom templates
                            </li>
                          </ul>
                        </div>
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 lg:p-12 rounded-[30px] border border-gray-200">
                    ...
                    <div className="flex flex-row mb-12 ml-0 mr-auto">
                      <div className="inline-flex items-center gap-4 bg-white px-6 py-3 rounded-full shadow-sm border border-gray-200 text-left justify-start">
                        ...
                        <span className="text-sm font-medium text-[#131417]">
                          Complete Crypto Tax Processing Journey
                        </span>
                        ...
                        {[
                          ...
                          <div key={index} className="relative group">
                            <div className="flex flex-col">
                              {/* Stage Card */}
                              <div
                                className={`${item.bgColor} ${item.borderColor} border-2 p-6 lg:p-8 rounded-[25px] hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group-hover:shadow-2xl`}
                              >
                                {/* Stage Header */}
                                <div className="text-center mb-6">
                                  <div
                                    className={`w-16 h-16 bg-gradient-to-br ${item.color} rounded-full flex items-center justify-center mb-4 mx-auto shadow-lg group-hover:shadow-xl transition-all duration-300`}
                                  >
                                    {item.icon}
                                  </div>
                                  <h4 className="text-xl font-bold text-[#131417] mb-2">
                                    {item.stage}
                                  </h4>
                                ...
                                <div className="space-y-4 text-sm">
                                  ...
                                  <div className="bg-white/80 p-4 rounded-[15px] border border-white/50">
                                    <div className="flex items-start gap-3">
                                      ...
                                      <div>
                                        <p className="font-semibold text-[#131417] mb-1">
                                          User Action
                                        </p>
              ...
              <div className="bg-white rounded-[25px] p-6 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <ul className="space-y-3">
                  <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                    ...
                    Lack of feedback → Introduced step-based upload & status
                    chips
                  </li>
                  <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                    <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-[200px]">
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="bg-[#131417] text-white p-8 rounded-[25px] transition-all duration-300 hover:scale-[1.02]">
                <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[20px] font-medium text-white mb-3 sm:mb-4 leading-tight transition-all duration-300">
                  💡 Design Principles:
                </h3>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-purple-50 p-6 rounded-[25px] border border-purple-200 transition-all duration-300 hover:border-purple-300 hover:scale-[1.02]">
                  <h4 className="text-[18px] font-medium text-[#131417] mb-2">
                    Classification Grid
                  </h4>
      ...
      <footer className="bg-[#131417] text-white animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-2900">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-[100px] py-16 lg:py-[135px_100px_134px]">
          {/* Footer Header */}
