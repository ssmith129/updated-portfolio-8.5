      ...
      <figure className="w-full max-w-6xl mx-auto mb-12 sm:mb-16 md:mb-20 lg:mb-24 animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-500">
        <div className="relative aspect-video w-full bg-gradient-to-r from-gray-100 to-gray-200 rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
          <img 
            ...
            alt="Computis - Crypto Tax Engine Hero Image" 
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
        <div className="text-center mb-8 sm:mb-12 md:mb-16 animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-700">
          ...
          <p className="text-base sm:text-lg md:text-[20px] font-normal text-[#9FA0A3] leading-[150%] tracking-[-0.16px] sm:tracking-[-0.18px] md:tracking-[-0.2px] max-w-[600px] mx-auto transition-all duration-300 hover:text-[#131417]">
            Streamlining crypto tax compliance through intelligent automation and user-friendly design.
          </p>
        </div>

        <div className="prose prose-lg max-w-none">
          <p>
            This case study showcases the design and development of Computis, a comprehensive crypto tax engine 
            that simplifies complex blockchain transaction analysis for accountants, individuals, and enterprises.
          </p>
          
          <h2>Challenge</h2>
          <p>
            Cryptocurrency taxation presents unique challenges due to the complexity of blockchain transactions, 
            multiple exchange formats, and evolving regulatory requirements. Users needed a solution that could 
            automatically categorize transactions, calculate tax implications, and generate compliant reports.
          </p>
          
          <h2>Solution</h2>
          <p>
            I designed an intuitive interface that abstracts complex tax calculations while providing transparency 
            into the underlying logic. The system features automated transaction import, intelligent categorization, 
            and comprehensive reporting tools.
          </p>
          
          <h2>Results</h2>
          <ul>
            <li>45% reduction in user onboarding time</li>
            <li>32% increase in conversion rates</li>
            <li>85% reduction in customer support inquiries</li>
          </ul>
        </div>
      </div>
    </div>
