      ...
      <main className="max-w-[1400px] mx-auto px-6 space-y-[14px] relative z-10 pb-20">
          ...
          <div className="bg-[#0F0F0F]/80 backdrop-blur-xl rounded-[25px] px-5 py-[10px] border border-[#1A1A1A] flex flex-col items-start gap-3">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-[#1A1A1A]/50 rounded-xl p-6 border border-[#2A2A2A] hover:border-[#00D4FF]/30 transition-all duration-300">
                <div className="text-[#9A9A9F] text-sm font-medium mb-2">
                  CPA Onboarding Time
                </div>
                <div className="text-[#34d399] text-3xl font-bold mb-1">
                  ↓ 45%
                </div>
              ...
              <div className="bg-[#1A1A1A]/50 rounded-xl p-6 border border-[#2A2A2A] hover:border-[#00D4FF]/30 transition-all duration-300">
                ...
                <div className="text-[#6A6A6F] text-sm">
              ...
              <div className="bg-[#1A1A1A]/50 rounded-xl p-6 border border-[#2A2A2A] hover:border-[#00D4FF]/30 transition-all duration-300 md:col-span-2 lg:col-span-1">
                ...
                <div className="text-[#a78bfa] text-3xl font-bold mb-1">
                  3 closed
                </div>
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-700">
          <div className="bg-[#0F0F0F]/80 backdrop-blur-xl rounded-[25px] px-8 py-[10px] border border-[#1A1A1A]">
            ...
            <p className="text-[#9A9A9F] text-lg leading-relaxed mb-6">
              ...
              transaction classification. The existing UI handled data well, but
              lacked intelligent automation features that competitors were
              beginning to offer.
            </p>
            <div className="mb-6">
            ...
            <div className="bg-[#f59e0b]/10 border border-[#f59e0b]/30 rounded-xl p-6">
              ...
              <p className="text-[#9A9A9F] leading-relaxed">
                ...
                routine work while keeping CPAs in control—turning Computis into
                a truly intelligent tax automation platform.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#0F0F0F]/80 backdrop-blur-xl rounded-[25px] px-8 py-[10px] border border-[#1A1A1A] hover:border-[#f59e0b]/30 transition-all duration-300">
              ...
              <div className="space-y-4">
                <div>
                  <div className="text-[#f87171] text-sm font-semibold uppercase tracking-wide mb-2">
                    Problem
                  </div>
                ...
                <div>
                  <div className="text-[#f59e0b] text-sm font-semibold uppercase tracking-wide mb-2">
                    Solution
                  </div>
                  <p className="text-[#9A9A9F]">
                    ML-driven auto-classification with visual confidence scores
                    (High/Medium/Low) and one-click accept/reject controls.
                  </p>
                </div>
                <div>
                  <div className="text-[#34d399] text-sm font-semibold uppercase tracking-wide mb-2">
                    Impact
                  </div>
                  <p className="text-[#9A9A9F]">
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-1000">
          <div className="bg-[#0F0F0F]/80 backdrop-blur-xl rounded-[25px] px-8 py-[10px] border border-[#1A1A1A]">
            ...
            <div className="mb-6">
              <h3 className="text-[#f87171] text-lg font-semibold mb-3">
                Challenge
              </h3>
              <p className="text-[#9A9A9F] leading-relaxed">
            ...
            <div className="mb-6">
              <h3 className="text-[#f59e0b] text-lg font-semibold mb-3">
                My Approach
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-[#9A9A9F]">
            ...
            <div className="mb-6">
              <h3 className="text-[#34d399] text-lg font-semibold mb-3">
                Outcome
              </h3>
          ...
          <div className="bg-[#0F0F0F]/80 backdrop-blur-xl rounded-[25px] px-8 py-[10px] border border-[#1A1A1A]">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-[#9A9A9F]">
                ...
                <span>
                  <span className="text-white font-semibold">
                    3 enterprise CPA firm deals
                  </span>{" "}
                  closed within 6 months of AI feature launch
                </span>
              </li>
              <li className="flex items-start gap-3 text-[#9A9A9F]">
              ...
              <li className="flex items-start gap-3 text-[#9A9A9F]">
                ...
                <span>
                  Platform capabilities expanded to serve{" "}
                  <span className="text-white font-semibold">
                    DAOs and hedge funds
                  </span>
                </span>
              </li>
              <li className="flex items-start gap-3 text-[#9A9A9F]">
                ...
                <span>
                  AI features cited as primary differentiator in{" "}
                  <span className="text-white font-semibold">
                    78% of won deals
                  </span>
                </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Figma", "Miro", "Notion", "Jira", "Mixpanel", "GA"].map(
                    (tool) => (
                      <span
                        key={tool}
