      ...
      <figure className="w-full max-w-6xl mx-auto mb-12 sm:mb-16 md:mb-20 lg:mb-24 animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-500">
        <div className="relative aspect-video w-full bg-gradient-to-r from-gray-100 to-gray-200 rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
          <img 
            ...
            alt="Medico - Hospital Management System Hero Image" 
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
        <div className="text-center mb-8 sm:mb-12 md:mb-16 animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-700">
          ...
          <p className="text-base sm:text-lg md:text-[20px] font-normal text-[#9FA0A3] leading-[150%] tracking-[-0.16px] sm:tracking-[-0.18px] md:tracking-[-0.2px] max-w-[600px] mx-auto transition-all duration-300 hover:text-[#131417]">
            Transforming hospital operations through comprehensive digital management solutions.
          </p>
        </div>

        <div className="prose prose-lg max-w-none">
          <p>
            This case study details the design and implementation of Medico, a comprehensive hospital management 
            system that streamlines operations from patient admission to discharge and beyond.
          </p>
          
          <h2>Challenge</h2>
          <p>
            Hospitals struggled with fragmented systems that didn't communicate effectively, leading to 
            inefficiencies in patient care, resource allocation, and administrative processes. The need was 
            for a unified platform that could handle all aspects of hospital management.
          </p>
          
          <h2>Solution</h2>
          <p>
            I designed an integrated dashboard system that provides real-time visibility into hospital operations, 
            including patient management, staff scheduling, inventory tracking, and financial reporting. The 
            interface prioritizes critical information while maintaining ease of use for diverse user roles.
          </p>
          
          <h2>Results</h2>
          <ul>
            <li>50% reduction in patient wait times</li>
            <li>35% improvement in resource utilization</li>
            <li>30% decrease in administrative overhead</li>
          </ul>
        </div>
      </div>
    </div>
