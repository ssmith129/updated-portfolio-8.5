        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-6 mt-8">
            <div className="bg-white p-4 rounded-[20px] shadow-sm">
              <p className="text-[14px] font-medium text-[#9FA0A3] mb-1">
                Role
              </p>
              <p className="text-[16px] font-medium text-[#131417]">
            ...
            <div className="bg-white p-4 rounded-[20px] shadow-sm">
              ...
              <p className="text-[16px] font-medium text-[#131417]">
                Streamline fragmented hospital operations
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-[100px] pb-24 space-y-24">
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-700">
          ...
          <div className="bg-white rounded-[25px] p-8 sm:p-10 lg:p-12 shadow-sm mb-8">
            <p className="text-lg text-[#131417] leading-[150%] mb-6">
              I led the 0→1 design of <strong>Medico</strong>, a SaaS hospital
              management platform that unified clinical and administrative
              workflows. The system integrated{" "}
              <strong>
                AI-driven staffing forecasts, inbox triage, and financial
                predictions
              </strong>
              , addressing fragmentation in hospital operations.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[16px] text-[#131417]">
                    admin time spent on scheduling/reporting
                  </span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[16px] text-[#131417]">
                    delays in diagnosis support workflows
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-orange-600 font-bold text-xl">83%</span>
                  <span className="text-[16px] text-[#131417]">
                    staff adoption over legacy tools
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-900">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-[25px] p-8 sm:p-10 lg:p-12 shadow-sm">
              <p className="text-lg text-[#131417] leading-[150%] mb-6">
                Hospitals typically operate across multiple disconnected systems
                for EHRs, HR, billing, and reporting. These silos drive
                inefficiencies, data duplication, and burnout.
              </p>

              <p className="text-lg text-[#131417] leading-[150%] mb-6">
                Medico was envisioned as a{" "}
                <strong>cloud-native SaaS management system</strong> that:
              </p>
              ...
              <ul className="space-y-3 mb-6">
                ...
                <li className="flex items-start gap-3 text-[#131417]">
                  <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                  Provides <strong>mobile-first accessibility</strong> for
                  doctors and admins
                </li>
                <li className="flex items-start gap-3 text-[#131417]">
                  <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                  Layers <strong>predictive AI intelligence</strong> for
                  proactive staffing, finances, and patient care
                </li>
              </ul>

              <div className="bg-blue-50 p-6 rounded-[20px] border-l-4 border-blue-500">
                <p className="text-[#131417] font-medium">
                  From a market perspective, Medico positioned itself against
                  incumbents like Epic and Cerner by focusing on{" "}
                  <strong>speed, usability, and AI augmentation</strong> rather
                  than legacy complexity.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-1100">
          ...
          <div className="bg-white rounded-[25px] p-8 sm:p-10 lg:p-12 shadow-sm">
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-lg text-[#131417] leading-[150%]">
                <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                Designed <strong>role-based dashboards</strong> for Admins and
                Doctors
              </li>
              <li className="flex items-start gap-3 text-lg text-[#131417] leading-[150%]">
                <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                Prototyped AI-driven modules (staffing, inbox, revenue
                predictions)
              </li>
              <li className="flex items-start gap-3 text-lg text-[#131417] leading-[150%]">
                <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                Delivered responsive <strong>Figma handoff</strong> for web +
                mobile
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-red-50 rounded-[20px] p-6 border-l-4 border-red-500">
              ...
              <p className="text-lg text-[#131417] leading-[150%]">
                ...
                juggle reporting across HR, billing, and schedules while doctors
                waste time navigating multiple interfaces.
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-[20px] p-6 border-l-4 border-blue-500">
              ...
              <p className="text-lg text-[#131417] leading-[150%]">
                Design a <strong>unified SaaS hub</strong> with an assistive AI
                layer that optimizes staffing, finances, and communications.
              </p>
            </div>

            <blockquote className="bg-[#131417] text-white p-8 rounded-[25px] italic text-xl leading-[150%]">
              "How might we transform siloed hospital workflows into a unified,
              adaptive platform that gives staff back time for patient care?"
            </blockquote>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-[20px] p-6 shadow-sm">
                ...
                <p className="text-[#131417] text-lg">
                  <strong>60%</strong> of time lost to manual
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-sm">
                ...
                <p className="text-[#131417] text-lg">
                  <strong>30+</strong> minutes/day wasted in fragmented tools
                </p>
              </div>
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-sm">
                ...
                <p className="text-[#131417] text-lg">
                  Longer wait times due to back-office inefficiency
                </p>
              </div>
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-sm">
                ...
                <p className="text-[#131417] text-lg">
                  <strong>72%</strong> of admins cited duplicate data entry as a
                  top frustration
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-[20px] p-6">
              ...
              <div className="space-y-4">
                <blockquote className="italic text-[#131417] border-l-4 border-orange-500 pl-4">
                  "By the time I finish reports, I have no energy left for
                  training staff." — Clinic Admin
                </blockquote>
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-1700">
          ...
          <div className="bg-white rounded-[25px] p-8 shadow-sm overflow-x-auto">
            <table className="w-full min-w-[600px]">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-4 px-4 text-[16px] font-bold text-[#131417]">
                    Platform
                  </th>
                  <th className="text-left py-4 px-4 text-[16px] font-bold text-[#131417]">
                    Strengths
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="py-4 px-4 text-[16px] text-[#131417]">
                    Lightweight, real-time SaaS + AI intelligence
                  </td>
                  <td className="py-4 px-4 text-[16px] text-[#131417]">
                    New to market
                  </td>
            ...
            <div className="mt-6 bg-green-50 p-4 rounded-[15px] border border-green-200">
              <p className="text-[#131417] font-medium">
                <strong>Medico Differentiator:</strong> Lightweight, real-time
                SaaS + AI intelligence for staffing forecasts, revenue
                predictions, and doctor-friendly mobile tools
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-1900">
          ...
          <div className="space-y-8">
            <div className="bg-red-50 rounded-[20px] p-6 border border-red-200">
              ...
              <p className="text-[#131417] text-lg">
                Scheduling in Excel → HR software → finance reporting tool →
            ...
            <div className="bg-green-50 rounded-[20px] p-6 border border-green-200">
              <h3 className="text-xl font-bold text-green-800 mb-4">
                Admin Workflow After (Medico)
              </h3>
              <p className="text-[#131417] text-lg">
                Unified dashboard → automated staffing optimizer → revenue
                forecasts → AI-triaged inbox → reduced context switching
              </p>
            </div>

            <div className="bg-blue-50 rounded-[20px] p-6 border border-blue-200">
              <h3 className="text-xl font-bold text-blue-800 mb-4">
                Doctor Workflow After
              </h3>
              <p className="text-[#131417] text-lg">
                Smart reminders → AI diagnosis assistant → mobile rounds
                dashboard
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[25px] p-8 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-[20px]">
                <h3 className="text-lg font-bold text-[#131417] mb-3">
                  1. Finance-first
                </h3>
              ...
              <div className="bg-green-50 p-6 rounded-[20px] border border-green-200">
                ...
                <p className="text-[#131417] text-sm">
                  Bridging admin + doctor needs with AI
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-sm">
              ...
              <p className="text-[#131417]">
                Proactive staffing/finance/diagnosis alerts
              </p>
            </div>
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-sm">
              ...
              <p className="text-[#131417]">
                Predictive revenue/cost forecasts with anomaly detection
              </p>
            </div>
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-sm">
              ...
              <p className="text-[#131417]">
                Touch-optimized, offline-ready for bedside use
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-6 duration-1000 delay-2500">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-green-50 rounded-[20px] p-6 border border-green-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-orange-600 font-bold text-xl">83%</span>
                  <span className="text-[16px] text-[#131417]">
                    adoption preference over legacy tools
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* Learnings */}
            <div className="bg-white rounded-[25px] p-8 shadow-sm">
              <h3 className="text-xl font-bold text-[#131417] mb-6">
                Learnings
              </h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-lg text-[#131417] leading-[150%]">
