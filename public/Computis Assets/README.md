...
```html
<!-- Static image -->
<img src="/Computis Assets/workflow-pain-points.png" 
...
<!-- Interactive version -->
<iframe src="/Computis Assets/workflow-pain-points.html" 
        width="1060" height="700" 
        title="Interactive Computis Workflow Pain Points Diagram"></iframe>
```
