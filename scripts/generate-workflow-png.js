  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // Save as PNG
        const buffer = canvas.toBuffer('image/png', { compressionLevel: 6, quality: 0.95 });
        ...
        const svgPath = path.join(__dirname, '..', 'public', 'Computis Assets', 'workflow-pain-points.svg');
        const readmePath = path.join(__dirname, '..', 'public', 'Computis Assets', 'README-PNG-GENERATION.md');
...
`;
        ...
        console.log('ℹ Please install sharp or canvas package, or convert manually.');
      }
    }
